# Code copied from https://github.com/trussworks/terraform-aws-s3-private-bucket

# mjheitland: I had to comment out the line below as it stops TF from processing for accounts without an alias
# data "aws_iam_account_alias" "current" {}

data "aws_partition" "current" {}

locals {
  bucket_prefix         = "" # mjheitland: see comment above!     var.use_account_alias_prefix ? format("%s-", data.aws_iam_account_alias.current.account_alias) : ""
